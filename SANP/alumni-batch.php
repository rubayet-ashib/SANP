...
<body>
    <div class="container-fluid">
        <div class="row w-100 d-flex flex-column">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse justify-content-end navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a class="nav-link active" href="alumni-news_feed.php">Alumni</a>
                                </li>
            ...
            <div class="sidebar-div">
                <div class="sidebar d-none d-md-flex justify-content-center">
                    <ul>
                        <li><a href="alumni-news_feed.php">News Feed</a></li>
                        <li>
                            <hr>
                        </li>
                        <!-- Visible to alumni only -->
                        <?php if ($_SESSION['role'] == "alumni") { ?>
                            <li><a href="alumni-batch.php" class="active">Batch</a></li>
                            <li>
                                <hr>
                            </li>
                        <?php } ?>
        ...
        <div class="post-container">
            ...
            $sql = "SELECT * FROM posts WHERE type = 'alumni-batch' AND batch_id = ? ORDER BY timestamp DESC";
            $stmt = $db->prepare($sql);
            if (!$stmt) {
                die("Prepare failed: " . $db->error);
            }
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class=" create-post-modal-body d-flex flex-column justify-content-center align-items-center w-100 p-3">
                                        ...
                                        <form action="edit_post-manager.php" method="POST" enctype="multipart/form-data" class="w-100">
                                            ...
                                            <input type="hidden" value="alumni-batch.php" name="from">
        ...
        <!-- Create Post Section -->
        <!-- Create Post Button div (visible to alumni only)-->
        <?php if ($_SESSION['role'] == "alumni") { ?>
                ...
                <div class="modal-content">
                    ...
                    <div class=" create-post-modal-body d-flex flex-column justify-content-center align-items-center w-100 p-3">
                        ...
                        <form action="create_post-manager.php" method="POST" enctype="multipart/form-data" class="w-100">
                            ...
                            <!-- Default Parameters  -->
                            <input type="hidden" value="alumni-batch" name="type">
