...
<body>
    ...
    <div class="post-container">
        ...
        <div class="post-card">
            ...
            <!-- Post Footer -->
            <div class="post-footer d-flex align-items-center border-top">
                <!-- Like Section -->
                <div class="communicate-container flex-fill d-flex justify-content-center align-items-center">
                    <div class="communicate d-flex align-items-center gap-3">
                        <img src="icons/communicate.svg" alt="">
                        <span class="count">Communicate</span>
                    </div>
                </div>
            </div>
